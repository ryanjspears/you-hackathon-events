...
See the [`DaytonaConfig` reference](https://www.daytona.io/docs/en/typescript-sdk/daytona.md#daytonaconfig) for details.
...
- [Secret](https://www.daytona.io/docs/en/typescript-sdk/secret.md)
...
- [WarmPool](https://www.daytona.io/docs/en/typescript-sdk/warm-pool.md)