...
:::note
The provider package major version must match the example's `ai` v6: use `@ai-sdk/openai@3` / `@ai-sdk/fireworks@2`. If you upgrade `ai` to v7, install the latest provider versions instead.
:::
