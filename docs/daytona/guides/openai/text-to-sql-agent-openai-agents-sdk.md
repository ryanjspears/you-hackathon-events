...
The agent also runs on any OpenAI-compatible provider such as [Fireworks AI](https://fireworks.ai/) - see [Using a Different Model Provider](https://www.daytona.io/docs/en/guides/openai/openai-agents-sdk-with-sandboxes.md#using-a-different-model-provider) for the model configuration.
